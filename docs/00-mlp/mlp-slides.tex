...
%------------------------------------------------
\begin{frame}
\frametitle{A Historical Perspective: The Weierstrass Approximation Theorem}

\begin{center}
\Large{\textbf{Can polynomials approximate ANY continuous function?}}
\end{center}

\vspace{0.5cm}

\textbf{Answer: YES! (Weierstrass 1885)}
...
\begin{itemize}
\item For any continuous $f: [a, b] \to \mathbb{R}$ and any $\epsilon > 0$
\item There exists a polynomial $p(x)$ such that:
...
%------------------------------------------------
\begin{frame}
\frametitle{Why Weierstrass Matters for Neural Networks}
...
\item Linear combinations: $\sum a_i x^i$
\item Universal approximators (1885)
\item Global support
\end{itemize}
...
\begin{itemize}
\item Building blocks: activation functions
\item Linear combinations + nonlinearity
\item Universal approximators (1989)
...
\begin{center}
\textbf{Key Insight:} Both achieve universal approximation through \\ linear combinations of simple basis functions!
\end{center}
...
%------------------------------------------------
\begin{frame}
\frametitle{Polynomial Approximation in Action}
...
\begin{itemize}
\item Higher degree $\rightarrow$ better approximation
\item Error decreases exponentially with degree
\item But: high-degree polynomials can oscillate (Runge's phenomenon)
\end{itemize}
...
%------------------------------------------------
\begin{frame}
\frametitle{Bernstein Polynomials: A Constructive Proof}

The Weierstrass theorem has a beautiful constructive proof using \textbf{Bernstein polynomials}:

$$B_n(f; x) = \sum_{k=0}^{n} f\left(\frac{k}{n}\right) \binom{n}{k} x^k (1-x)^{n-k}$$

\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{figs/bernstein-approximation.png}
\end{figure}

\begin{itemize}
\item Converges uniformly to $f$ as $n \to \infty$
\item Always stays within range of function
\item Forms basis for Bézier curves in computer graphics!
\end{itemize}
...
%------------------------------------------------
\begin{frame}
\frametitle{Polynomials vs Neural Networks: Direct Comparison}
...
\begin{columns}[c]
\column{0.5\textwidth}
\textbf{Polynomial (degree 9)}
\begin{itemize}
\item 10 parameters
\item Global support
\item Can oscillate wildly
\end{itemize}

\column{0.5\textwidth}
\textbf{Neural Network (10 hidden)}
\begin{itemize}
\item 21 parameters
\item Local support (Sigmoid)
\item Stable approximation
\end{itemize}
\end{columns}
...
%------------------------------------------------
\begin{frame}
\frametitle{From Weierstrass to Universal Approximation}

\begin{center}
\textbf{The Evolution of Approximation Theory}
\end{center}

\begin{table}
\begin{tabular}{l|l|l}
\textbf{Year} & \textbf{Result} & \textbf{Key Insight} \\
\hline
1885 & Weierstrass & Polynomials are universal \\
1900s & Stone-Weierstrass & Generalized to other algebras \\
1957 & Kolmogorov & Multi-variable functions \\
1989 & Cybenko & Single-layer NNs are universal \\
1991 & Hornik & Any activation function works \\
2017+ & Deep Learning & Depth is exponentially efficient \\
\end{tabular}
\end{table}
...
\begin{center}
\textbf{Neural networks are the latest chapter in a long mathematical story!}
\end{center}
