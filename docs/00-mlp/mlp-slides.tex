...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{figs/relu-interactive-demo.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{figs/halfspace-isolation.png}
\caption*{How half-spaces isolate any point}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{figs/activation-comparison.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{figs/bias-breakpoints.png}
