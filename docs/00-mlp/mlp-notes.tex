...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{figs/polynomial-approximation-sinpi.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{figs/bernstein-approximation.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figs/polynomial-vs-nn-comparison.png}
